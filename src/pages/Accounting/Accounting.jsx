...
export default function Accounting() {
    ...
    return (
        <>
            <img></img>
            <button></button>
            <h1>Getting expert <span className="blue">just got a lot easier.</span></h1>
            ...
            <h2 class="light">Our experienced <span id="highligh-bold">Certified Public Accountants</span> are ready to advise you on a variety of financial management topics:</h2>
            <img></img>
            <button></button>
        </>
    )
